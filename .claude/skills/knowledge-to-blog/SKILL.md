...
ネタの型の全体と、書く前の下調べ、自分の言葉で書くこと、読み手の決め方は `references/writing-craft.md` の 1〜5 にある。
...
構成の型（エラー解決と実装紹介）、見出し、タイトルは `references/writing-craft.md` の 6〜8 に従う。
...
見せ方（コードと本文の割合、画像、動画、図）と Markdown の書き方は `references/writing-craft.md` の 9〜10 に従う。
...
スクリプトの後に、`references/writing-craft.md` の 11「正しい情報を正しく伝える」の確認の順番、12「時点と前提を明確にする」、13「公開前の確認」をすべて確かめる。
そのうえで、書いた文脈を持たない読み手として読み直す。
